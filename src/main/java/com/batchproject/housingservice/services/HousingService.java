...
import com.batchproject.housingservice.configs.exceptions.customexceptions.BadDataException;
import com.batchproject.housingservice.configs.exceptions.customexceptions.ItemNotFoundException;
import com.batchproject.housingservice.externalservice.RentPriceExternal;
import com.batchproject.housingservice.externalservice.RentServiceClient;
import com.batchproject.housingservice.models.BulkIdPayload;
import com.batchproject.housingservice.models.address.Address;
import com.batchproject.housingservice.models.housing.*;
...
//            housingBuildingRepository.flush();
    ...
    public CompletableFuture<HousingDetailsDTO> getFullBuildingDetails(Long buildingId) {
        ...
        System.out.println("let me see the list of rent i have got");
        ...
        listOfRent.stream().forEach(rent -> idMap.put(rent.getSuiteId(), rent));
